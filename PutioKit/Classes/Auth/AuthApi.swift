...
extension PutioKit {
    func login(username: String, password: String, clientName: String, completion: @escaping (_ token: String?, _ error: Error?) -> Void) {
    ...
    func getAuthCode(clientName: String, completion: @escaping (_ code: String?, _ error: Error?) -> Void) {
        let clientName = clientName.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
    ...
    func checkAuthCodeMatch(code: String, completion: @escaping (_ token: String?, _ error: Error?) -> Void) {
