...
final class PutioSDKAuthTests: XCTestCase {
    ...
    func testAuthAndTwoFactorEndpointsDecodeTypedResponses() async throws {
        ...
        XCTAssertEqual(validation.tokenID, 44)
        XCTAssertEqual(validation.tokenScope, "stream")
        XCTAssertEqual(validation.userID, 12)
    ...
    func testAuthModelsDecodeGracefulDefaults() throws {
        ...
        XCTAssertEqual(validation.tokenID, 0)
        XCTAssertEqual(validation.tokenScope, "")
        XCTAssertEqual(validation.userID, 0)
