...
extension PutioAPI {
    public func login(username: String, password: String, clientName: String, completion: @escaping (_ token: String?, _ error: PutioAPIError?) -> Void) {
    ...
    public func getAuthCode(clientName: String, completion: @escaping (_ code: String?, _ error: PutioAPIError?) -> Void) {
        let clientName = clientName.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)
    ...
    public func checkAuthCodeMatch(code: String, completion: @escaping (_ token: String?, _ error: PutioAPIError?) -> Void) {
    ...
    public func validateToken(token: String, completion: @escaping (_ result: PutioTokenValidationResult?, _ error: PutioAPIError?) -> Void) {
    ...
    public func verifyTOTP(totp: String, completion: @escaping (_ result: PutioVerifyTOTPResult?, _ error: PutioAPIError?) -> Void) {
