...
open class PutioFile {
    ...
    init(json: JSON) {
        ...
        self.createdAt = formatter.date(from: json["created_at"].stringValue) ??
            formatter.date(from: "\(json["created_at"].stringValue)+00:00")!
        ...
        self.updatedAt = formatter.date(from: json["updated_at"].stringValue) ??
